...
<div class="right">
        ...
        <div class="search">
        	<form method="get" action="../Provider/Providerlist.html">
        ...
        <table class="providerTable" cellpadding="0" cellspacing="0">
            ...
            <c:forEach var="provider" items="${providerList }" varStatus="status">
				<tr>
					...
					<td>
					<span><a class="viewProvider" href="../Provider/Providerview.html" proid=${provider.id } proname=${provider.proName }><img src="${pageContext.request.contextPath }/statics/images/read.png" alt="查看" title="查看"/></a></span>
					<span><a class="modifyProvider" href="../Provider/Providermodify.html" proid=${provider.id } proname=${provider.proName }><img src="${pageContext.request.contextPath }/statics/images/xiugai.png" alt="修改" title="修改"/></a></span>
